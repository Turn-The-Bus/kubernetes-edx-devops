...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_data_backup_s3_bucket"></a> [openedx\_s3\_bucket](#module\_openedx\_s3\_bucket) | terraform-aws-modules/s3-bucket/aws |  |
...
| [kubernetes_secret.s3](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/secret) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_base_domain"></a> [base\_domain](#input\_base\_domain) | base domain for service | `string` | n/a | yes |
| <a name="input_bucket_name"></a> [bucket\_name](#input\_bucket\_name) | Name of the Open edX S3 bucket | `string` | `null` | no |
