## EKS
This stack creates a fully functional EKS cluster in target VPC.
The EKS cluster will have a pool of worker nodes, an ingress controller and a certificate manager.

Terragrunt inputs example:
```
inputs = {
  cluster_name    = "${local.platform_name}-eks-${local.env}"
  ...
  #worker group
  worker_group_asg_max_size  = 2
  worker_group_asg_min_size  = 2
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_cert_manager_irsa"></a> [cert\_manager\_irsa](#module\_cert\_manager\_irsa) | terraform-aws-modules/iam/aws//modules/iam-assumable-role-with-oidc | 4.1.0 |
...
| [aws_route53_record.ingress](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route53_record) | resource |
| [aws_route53_record.ingress_domains_naked](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route53_record) | resource |
| [aws_route53_record.ingress_domains_wildcard](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route53_record) | resource |
| [aws_route53_record.naked](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route53_record) | resource |
| [aws_route53_record.subdomain-ns](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route53_record) | resource |
...
| [aws_route53_zone.legacy_zone](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/route53_zone) | data source |
...
| [template_file.cert-manager-values](https://registry.terraform.io/providers/hashicorp/template/latest/docs/data-sources/file) | data source |
...
| <a name="input_base_domain"></a> [base\_domain](#input\_base\_domain) | Base domain (route53 zone) for the default cluster ingress | `string` | n/a | yes |
...
| <a name="input_oidc_thumbprint_list"></a> [oidc\_thumbprint\_list](#input\_oidc\_thumbprint\_list) | A list of server certificate thumbprints for the OpenID Connect (OIDC) identity provider's server certificate(s). | `list(string)` | `[]` | no |
| <a name="input_permissions_boundary"></a> [permissions\_boundary](#input\_permissions\_boundary) | If provided, all IAM roles will be created with this permissions boundary attached. | `string` | `null` | no |
| <a name="input_subdomains"></a> [subdomains](#input\_subdomains) | Base domain (route53 zone) for the default cluster ingress | `list(string)` | n/a | yes |
...
| <a name="input_worker_group_asg_max_size"></a> [worker\_group\_asg\_max\_size](#input\_worker\_group\_asg\_max\_size) | Max number of nodes on the worker group ASG | `number` | `1` | no |
| <a name="input_worker_group_asg_min_size"></a> [worker\_group\_asg\_min\_size](#input\_worker\_group\_asg\_min\_size) | Min number of nodes on the worker group ASG | `number` | `1` | no |
| <a name="input_worker_group_instance_type"></a> [worker\_group\_instance\_type](#input\_worker\_group\_instance\_type) | Instance type for the worker group | `string` | `null` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_cert_manager_irsa_role_arn"></a> [cert\_manager\_irsa\_role\_arn](#output\_cert\_manager\_irsa\_role\_arn) | n/a |
