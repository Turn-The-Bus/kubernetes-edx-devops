...
We need a custom image because we need to pack a custom [theme](https://github.com/turnthebus/stepwise-edx-theme) and
an integration [plug-in](https://github.com/turnthebus/stepwise-edx-plugin) for edx-platform.
...
## Building an image
To manually trigger the build of a new image, we need to head to [GitHub's actions tab](https://github.com/turnthebus/tutor-build/actions)
...
This value then needs to be updated on the target environment's configuration on the [deployment repository](https://github.com/turnthebus/tutor-deploy).
