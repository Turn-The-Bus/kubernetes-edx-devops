...
- CDN at https://cdn.app.turnthebus.org linked to a public read-only S3 bucket named app-turnthebus-mumbai-storage
- public ssh access via a t2.micro Ubuntu 20.04 LTS bastion EC2 instance at bastion.app.turnthebus.org
- daily data backups archived into a private S3 bucket named app-turnthebus-mumbai-mongodb-backup
...
IV. Build your Tutor Docker Image
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
